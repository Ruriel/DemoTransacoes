...
import br.itau.unibanco.example.transacoes.DemoTransacoes.application.usecase.LimparTransacoesUseCase;
...
public class TransacaoController {
    ...
    private final LimparTransacoesUseCase limparTransacoesUseCase;
    ...
    public ResponseEntity<?> deletar() {
        limparTransacoesUseCase.executar();
